...
DepositUI::DepositUI(QWidget *parent) : QWidget(parent), ui(new Ui::DepositUI) {
  ui->setupUi(this);
}

DepositUI::~DepositUI() { delete ui; }

void DepositUI::on_pushButton_clicked() {
  bool ok;
...
QVector<double> DepositUI::parseList(const QString &list) {
